...
fviz_cluster(final, geom = "point", ellipse.type = "convex", palette="jco", ggtheme = theme_minimal())
```
...
```{r}
gmm_result2 <- Mclust(dati, G=2)
summary(gmm_result2)
gmm_result3 <- Mclust(dati, G=3)
summary(gmm_result3)
```
