...
### 4.3 Scelta automatica del miglior algoritmo di clustering
```{r}
# library(clValid)
# 
# clmethods <- c("hierarchical", "kmeans","pam")
# intern <- clValid(df, 2:10, clmethods, "internal")
# intern <- clValid(df_ridotto, nClust = 2:10, clmethods, "internal")
# intern <- clValid(df_pca, 2:10, clmethods, "internal")
# summary(intern)
# 
# stab <- clValid(df, 2:10, clmethods, "stability")
# summary(stab)
# 
# stab2 <- clValid(df_ridotto, 2:10, clmethods, "stability")
# summary(stab2)
# optimalScores(stab2)
# 
# stab3 <- clValid(df_pca, 2:10, clmethods, "stability")
# summary(stab3)
# optimalScores(stab3)
```
