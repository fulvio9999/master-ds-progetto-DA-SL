...
Nel grafico il gomito sembra collocarsi intorno alla terza componente. Sulla base dei dati ottenuti si sceglie di mantenere un numero di componenti principali pari a 3.  
...
Applicando il clustering agglomerativo con metodo "average" su 3 componenti principali (PCA) e 2 cluster, si ottiene la combinazione migliore secondo la maggior parte degli indici di valutazione, con silhouette e VI al primo posto, ma un indice Dunn debole.
